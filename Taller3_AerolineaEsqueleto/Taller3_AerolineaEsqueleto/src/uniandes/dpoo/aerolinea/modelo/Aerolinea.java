...
public class Aerolinea
{
    ...
    public Collection<Tiquete> getTiquetes( )
    {
    	...
    	for (Vuelo vuelo : vuelos) {
			todos.addAll(vuelo.getTiquetes());
		}
    	return todos;
    }
    ...
    public void programarVuelo( String fecha, String codigoRuta, String nombreAvion ) throws Exception
    {
    	...
    	if (ruta == null) {
			throw new Exception("No eiste una ruta con codigo: " + codigoRuta);
		}
    	
    	Avion avion = buscarAvionPorNombre(nombreAvion);
    	if (avion == null) {
			throw new Exception("No existe un avion con nombre: " + nombreAvion);
		}
    	
    	for (Vuelo vuelo : vuelos) {
			if (vuelo.getFecha().equals(fecha) && vuelo.getAvion().getNombre().equals(nombreAvion)) {
				throw new Exception("El avion ya tiene un vuelo programado en esa fecha");
			}
		}
    ...
    public int venderTiquetes( String identificadorCliente, String fecha, String codigoRuta, int cantidad ) throws VueloSobrevendidoException, Exception
    {
    	...
    	if (cliente == null) {
			throw new Exception("No existe el cliente con identificador: " + identificadorCliente);
		}
